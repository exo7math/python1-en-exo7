...
\objectifs{You will find here comments and readings on each of the activities.}
...
%}
  ...
  % Unfortunately some pages are in English  
  \mycenterline{
...
The \ci{tkinter} module allows a graphic display. To begin with, you have to copy the lines of a code that works without asking yourself too many questions, then adapt it to your needs.
...
We have tried to postpone as much as possible the change of a global variable in a function, but here it is natural. The use of \ci{global} is to be avoided in general.
