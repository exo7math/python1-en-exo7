...
The first line imports all the functions of the module named \ci{math}\index{import@\ci{import}}, the second line calculates $x = \sqrt{2}$ (as an approximate value) and then displays $x$ and $x^2$.	
