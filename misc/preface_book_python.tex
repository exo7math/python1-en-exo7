...
\descriptionactivite{The module \ci{turtle} allows you to easily make drawings in \Python. It's about ordering a turtle with simple instructions like \og{}go ahead\fg{}, \og{}turn\fg{}\ldots{} It's the same principle as with \emph{Scratch}, but with one difference: you no longer move blocks, but you write the instructions.}
...
\descriptionactivite{We continue our exploration of the world of $0$ and $1$.}
...
\descriptionactivite{The \emph{game of life} is a simple model of the evolution of a population of cells that born and die over time. The \og{}game\fg{} consists in finding initial configurations that give interesting evolution: some groups of cells disappear, others stabilize, some move\ldots}
