...
\descriptionactivite{Our study of numbers is further developed with the \og{}while\fg{} loop. For this chapter you will need the \ci{is_prime()} function you wrote in the \og{}Arithmetic -- While loop -- I\fg{} part.}
...
\descriptionactivite{The \emph{game of life} is a simple model of the evolution of a population of cells that split and die over time. The \og{}game\fg{} consists in finding initial configurations that give interesting evolution: some groups of cells disappear, others stabilize, some move\ldots}
