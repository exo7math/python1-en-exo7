...
\insertcode{../lists/lists_I_1.py}{Activity 2 \hfill \texttt{lists\_I\_2.py}}

\subsection*{Activity 3}

\insertcode{../lists/lists_I_1.py}{Activity 3 \hfill \texttt{lists\_I\_3.py}}

\subsection*{Activity 4}

\insertcode{../lists/lists_I_1.py}{Activity 4 \hfill \texttt{lists\_I\_4.py}}
