...
\objectifs{The module \ci{turtle} allows you to easily make drawings in \Python. It's about ordering a turtle with simple instructions like \og{}go ahead\fg{}, \og{}turn\fg{}\ldots{} It's the same principle as with \emph{Scratch}, but with one difference: you no longer move blocks, but you write the instructions.}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{cours}[The turtle \Python]
...
\objectifs{Goal: picture your first drawings.}
...
\objectifs{Goal: drawing geometric shapes.}
...
By default \Python{} does not know the sine function, to use \ci{sin()} you must first import the module \ci{math}:
...
Here's how to get the coordinates of the vertices. This is done with the sine and cosine functions (available from module \ci{math}).
